    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">User Door Acces Add</h3>
            </div>
            <?php echo form_open('user_door_acces/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="door_id" value="<?php echo $this->input->post('door_id'); ?>" class="form-control" id="door_id" />
						</div>
					</div>
				</div>
			</div>
