    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Device Door Edit</h3>
            </div>
			<?php echo form_open('device_door/edit/'.$device_door['id']); ?>
			<div class="box-body">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="device_id" class="form-control">
								...
								{
									$selected = ($device_master['id'] == $device_door['device_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="door_id" class="form-control">
								...
								{
									$selected = ($door_master['id'] == $device_door['door_id']) ? ' selected="selected"' : "";
