    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Door Master Add</h3>
            </div>
            <?php echo form_open('door_master/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						<label for="door_name" class="control-label">Door Name</label>
						<div class="form-group">
							<input type="text" name="door_name" value="<?php echo $this->input->post('door_name'); ?>" class="form-control" id="door_name" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<textarea name="qr_string" class="form-control" id="qr_string"><?php echo $this->input->post('qr_string'); ?></textarea>
						</div>
					</div>
				</div>
			</div>
