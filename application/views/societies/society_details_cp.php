            ...
            <div class="card-body p-3 border">
              <div class="table-responsive">
                <table class="col-md-12 zi-table table-hover table-condensed cf table-sm" id="table-1">
                  <thead>
                    <tr>
                      <th class="text-center w15">Society Name</th>
...
let add_single_payment =
  '<div class="form-group row mb-4"><label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Amount<span class="required"> *</span></label><div class="col-sm-12 col-md-7"><input type="text" name="amount1" id="amount1" class="form-control" required=""></div></div>';
add_single_payment +=
