...
$b_heads = array();
$op_balance = array();
$society_credit_amount_total =0;
$society_debit_amount_total = 0;
?>
                      ...
                      <table class="table table-striped" id="table_bill">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="text-center"><?= $rdata['bill_no'] ?></td>
                            ...
                            <td class="text-center"><?= $op_balance[$row] = round($rdata['principal_arrears']+$rdata['interest_arrears']);//round(-$this->Member_model->get_bill_register_op_balance($rdata['member_id'],$this->uri->segment(4)),2); ?></td>
                            ...
                            <td class="text-center">
                              <?= round($rd['Parking Charges']) ?>
                            </td>
                            <td class="text-center">
                              <?= round($rd['NOC Charges']) ?>
                            </td>
                            <?php
                            ...
                            $society_debit_amount = $this->Payment_model->get_debit_notes_sum($rdata['society_id'], $last_month, date('Y-m-d h:i:s',strtotime($rdata['bill_date'])));
                              ...
                              $society_credit_amount_total = $society_credit_amount[0]['credit'] + $credit_amount;
                              $society_debit_amount_total = $society_debit_amount[0]['credit'] + $debit_amount;
                            ?>
                            <td class="text-center"> <?= round($credit_amount) ?></td>

                            <td class="text-center"><?= round($debit_amount) ?></td>

                            <td class="text-center"><?= round($rdata['interest']) ?></td>

                            <td class="text-center"><?= round($rdata['bill_amount']) ?></td>

                            <td class="text-center"><?= round($rdata['total_due']) ?></td>
                          ...
                          <th class="text-center"><?= round(array_sum($op_balance)); ?></th>
                          <?php foreach($b_heads as $k => $b) :?>
                            <th class="text-center"><?= round(array_sum($b)) ?></th>
                          <?php endforeach; ?>
                          <th class="text-center"><?= round($total_parking_charge); ?></th>
                          <th class="text-center"><?= round($total_noc_charge); ?></th>
                          <th class="text-center"><?= round($society_credit_amount_total) ?></th>
                          <th class="text-center"><?= round($society_debit_amount_total) ?></th>
                         
                          <th class="text-center"><?= round($total_interest[0]->interest); ?></th>
                          <th class="text-center"><?= round($total_bill_amount[0]->bill_amount);?></th>
                          <th class="text-center"><?= round($total_due[0]->total_due); ?></th>
                        </tr>
                      </table>
