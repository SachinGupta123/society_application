                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                          ...
                          <select class="form-control select" name="groups[]" id="role" required="" oninvalid="setCustomValidity('Please select role')" onchange="try{setCustomValidity('')}catch(e){}" >
                      ...
                      <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                          ...
                          <a class="btn btn-danger text-white" href="<?php echo base_url("users")?>">Cancel Changes</a> 
