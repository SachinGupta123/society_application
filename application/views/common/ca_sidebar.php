  ...
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
        <li class="<?php if ($this->uri->segment(1) == "societies"  && $this->uri->segment(2) != "society_users") echo "active"; ?>">
         <a class="nav-link" href="<?php echo base_url(); ?>societies"><i class="far fa-building"></i>
           <span>Societies </span></a>
        </li>
        <?php if (($this->uri->segment(1) == "societies" &&  empty($this->uri->segment(2)) )|| $this->uri->segment(1) == "bill_head_master"){ ?>
            <li class="<?php if ($this->uri->segment(1) == "bill_head_master"||$this->uri->segment(1) == "billing_head") echo 'active'; ?>"><a class="nav-link" href="<?php echo base_url("bill_head_master"); ?>"><i class="far fa-square"></i><span>Bill Head Master</span></a></li>
        <?php }?>

        <?php  if(($this->uri->segment(1) != "bill_head_master") && !empty($this->uri->segment(3))){  ?>
          ...
          <li class="<?php if ($this->uri->segment(1) == "societies_payment") echo  'active'; ?>"><a class="nav-link" href="<?php echo base_url("societies_payment/society_single_payment/") . $this->uri->segment(3); ?>"><i class="fas fa-hand-holding-usd"></i><span>Payment</span></a></li>
