...
<div class="main-sidebar sidebar-style-2 elevation-4 ">
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
        ...
        <li class="<?php if ($this->uri->segment(1) == "societies" && $this->uri->segment(2) != "society_users") echo "active"; ?>">
        <a class="nav-link" href="<?php echo base_url('societies'); ?>"><i class="fa fa-columns"></i><span>Societies</span></a> </li>

        <?php if(!empty($this->uri->segment(3))){ ?>

        <li class="<?php if ($this->uri->segment(1) == "society_access_user" || $this->uri->segment(2) == "society_users") echo  'active'; ?>"><a class="nav-link" href="<?php echo base_url("societies/society_users/").$this->uri->segment(3); ?>"><i class="fa fa-users"></i><span>User </span></a></li>
        ...
        <li class="dropdown <?php if ($this->uri->segment(1) == "member" || $this->uri->segment(1) == "flat_types" || $this->uri->segment(1) == "users" || $this->uri->segment(1) == "billing_head")  echo 'active'; ?>">
        <a href="#" class="nav-link has-dropdown"><i class="far fa-building"></i><span>Flats</span></a>
        ...
        <a class="nav-link" href="<?php echo base_url("societies_payment/society_single_payment/") . $this->uri->segment(3); ?>"><i class="ion-ios-paper"></i>
