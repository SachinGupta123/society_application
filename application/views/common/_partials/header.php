...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/modules/bootstrapLatest/css/bootstrap.min.css">
...
} elseif ($this->uri->segment(2) != "tnc" && $this->uri->segment(2) != "login" && $this->uri->segment(2) != "collect_response" && $this->uri->segment(2) != "enroll" && $this->uri->segment(2) != "channel_partner" && $this->uri->segment(2) != "forgot_password" && $this->uri->segment(2) != "register" && $this->uri->segment(2) != "reset_password" && $this->uri->segment(2) != "errors_503" && $this->uri->segment(2) != "errors_403" && $this->uri->segment(2) != "errors_404" && $this->uri->segment(2) != "errors_500" && $this->uri->segment(2) != "utilities_contact" && $this->uri->segment(2) != "utilities_subscribe") {
