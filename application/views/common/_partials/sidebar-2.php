    ...
    <ul class="sidebar-menu">
      ...
      <li class="dropdown <?php echo $this->uri->segment(2) == 'layout_transparent' ? 'active' : ''; ?>">
        ...
        <ul class="dropdown-menu">
          ...
          <li class="<?php echo $this->uri->segment(2) == 'layout_transparent' ? 'active' : ''; ?>"><a class="nav-link"
              href="<?php echo base_url(); ?>dist/layout_transparent">Transparent Sidebar</a></li>
      ...
      <li><a class="nav-link" href="<?php echo base_url(); ?>dist/blank"><i class="far fa-square"></i> <span>Blank
            Page</span></a></li>
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a class="nav-link beep beep-sidebar" href="<?php echo base_url(); ?>dist/components_avatar">Avatar</a>
          </li>

          <li><a class="nav-link" href="<?php echo base_url(); ?>dist/components_chat_box">Chat Box</a></li>

          <li><a class="nav-link beep beep-sidebar" href="<?php echo base_url(); ?>dist/components_empty_state">Empty
              State</a></li>
          ...
          <li><a class="nav-link" href="<?php echo base_url(); ?>dist/components_multiple_upload">Multiple Upload</a>
          </li>

          <li><a class="nav-link beep beep-sidebar" href="<?php echo base_url(); ?>dist/components_pricing">Pricing</a>
          </li>
          ...
          <li><a class="nav-link beep beep-sidebar" href="<?php echo base_url(); ?>dist/components_wizard">Wizard</a>
          </li>
