...
class Dist extends CI_Controller {
	...
	// 		'title' => "Login"
	// 	);
	// 	$this->load->view('auth/login_msoc', $data);
	// }
	...
	// 	);
	// 	$this->load->view('dist/view_expense_categories', $data);
	// }
	...
	// public function edit_expense_categories() {
	// 	$data = array(
	// 		'title' => "Expense Categories"
	// 	);
	...
	// public function edit_utility_provider() {
	// 	$data = array(
	// 		'title' => "Utility Service Provider"
	// 	);
	...
	public function login_msoc() {
		$data = array(
			'title' => "Login"
		);
		$this->load->view('dist/login_msoc', $data);
	}
